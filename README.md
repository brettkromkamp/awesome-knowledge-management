...
- [PaperAgent](https://github.com/hui-xu-ai/PaperAgent) - Local-first literature and knowledge workbench: parses scientific PDFs, compiles three-level knowledge notes (L1/L2/L3), translates them and answers questions over a local full-text index (single-user Windows app, MIT)
